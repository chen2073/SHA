...
class SHA512(object):
    ...
    def sha512(self):
        ...
        #  The 8 64-bit words used for initializing the 1024-bit hash buffer before we start scanning the
        #  input message block for its hashing.
        ...
        #  of each 1024-bit input message block.  There is a 64-bit constant for each of the 64 rounds.
        ...
        for n in range(0, bv4.length(), 1024):
            ...
            #  that contains 64 64-bit words. This involves using the functions sigma0 and sigma1 as shown
            #  below:
